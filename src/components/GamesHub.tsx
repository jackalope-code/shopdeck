      ...
      <header className="sticky top-14 z-50 bg-[#f5f7f8]/80 dark:bg-[#101922]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center px-4 py-3 gap-3 max-w-3xl mx-auto w-full">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-400">Video games, board games & deals</p>
          </div>
        </div>
      </header>
      <main className="pb-24 md:pb-6">
        <div className="max-w-3xl mx-auto w-full px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <SectionCard title="Video Game Deals" icon="sports_esports" iconClass="text-purple-500">
            <FeedPreview widgetId="games-video-deals" trackerHref="/active-deals" trackerLabel="View all video game deals" icon="sports_esports" iconClass="text-purple-500" />
          </SectionCard>
          <SectionCard title="New Video Games" icon="new_releases" iconClass="text-blue-500">
            <FeedPreview widgetId="games-video-new" trackerHref="/dashboard" trackerLabel="View new video games" icon="new_releases" iconClass="text-blue-500" />
          </SectionCard>
          <SectionCard title="Board Game Deals" icon="sell" iconClass="text-amber-500">
            <FeedPreview widgetId="games-board-deals" trackerHref="/active-deals" trackerLabel="View board game deals" icon="sell" iconClass="text-amber-500" />
          </SectionCard>
          <SectionCard title="New Board Games" icon="casino" iconClass="text-green-500">
            <FeedPreview widgetId="games-board-new" trackerHref="/dashboard" trackerLabel="View new board games" icon="casino" iconClass="text-green-500" />
          </SectionCard>
          <SectionCard title="Tabletop & RPG" icon="casino" iconClass="text-red-500">
            <FeedPreview widgetId="games-tabletop" trackerHref="/dashboard" trackerLabel="View tabletop & RPG" icon="casino" iconClass="text-red-500" />
          </SectionCard>
          <SectionCard title="All Game Deals" icon="sell" iconClass="text-orange-400">
            <FeedPreview widgetId="games-deals" trackerHref="/active-deals" trackerLabel="View all game deals" icon="sell" iconClass="text-orange-400" />
          </SectionCard>
        </div>
      </main>
