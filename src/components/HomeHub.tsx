      ...
      <header className="sticky top-14 z-20 bg-[#f5f7f8]/80 dark:bg-[#101922]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center px-4 py-3 gap-3 max-w-3xl mx-auto w-full">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-400">Decor, furniture, kitchen & home deals</p>
          </div>
        </div>
      </header>
      <main className="pb-24 md:pb-6">
        <div className="max-w-3xl mx-auto w-full px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <SectionCard title="Home Decor" icon="home" iconClass="text-rose-500">
            <FeedPreview widgetId="home-decor" trackerHref="/dashboard" trackerLabel="View all home decor" icon="home" iconClass="text-rose-500" />
          </SectionCard>
          <SectionCard title="Furniture" icon="chair" iconClass="text-amber-800">
            <FeedPreview widgetId="home-furniture" trackerHref="/dashboard" trackerLabel="View all furniture" icon="chair" iconClass="text-amber-800" />
          </SectionCard>
          <SectionCard title="Kitchen & Appliances" icon="kitchen" iconClass="text-yellow-600">
            <FeedPreview widgetId="home-kitchen" trackerHref="/dashboard" trackerLabel="View kitchen & appliances" icon="kitchen" iconClass="text-yellow-600" />
          </SectionCard>
          <SectionCard title="Home Deals" icon="sell" iconClass="text-amber-500">
            <FeedPreview widgetId="home-deals" trackerHref="/active-deals" trackerLabel="View all home deals" icon="sell" iconClass="text-amber-500" />
          </SectionCard>
        </div>
      </main>
