      ...
      <header className="sticky top-14 z-20 bg-[#f5f7f8]/80 dark:bg-[#101922]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center px-4 py-3 gap-3 max-w-3xl mx-auto w-full">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold">Sports Equipment</h1>
            <p className="text-xs text-slate-400">Gear, equipment & deals across all sports</p>
          </div>
        </div>
      </header>
      <main className="pb-24 md:pb-6">
        <div className="max-w-3xl mx-auto w-full px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <SectionCard title="New Equipment" icon="new_releases" iconClass="text-blue-500">
            <FeedPreview widgetId="sports-new-releases" trackerHref="/dashboard" trackerLabel="View all new equipment" icon="new_releases" iconClass="text-blue-500" />
          </SectionCard>
          <SectionCard title="Sports Deals" icon="sell" iconClass="text-amber-500">
            <FeedPreview widgetId="sports-deals" trackerHref="/active-deals" trackerLabel="View all sports deals" icon="sell" iconClass="text-amber-500" />
          </SectionCard>
          <SectionCard title="Baseball" icon="sports_baseball" iconClass="text-red-600">
            <FeedPreview widgetId="sports-baseball" trackerHref="/dashboard" trackerLabel="View baseball gear" icon="sports_baseball" iconClass="text-red-600" />
          </SectionCard>
          <SectionCard title="Basketball" icon="sports_basketball" iconClass="text-orange-500">
            <FeedPreview widgetId="sports-basketball" trackerHref="/dashboard" trackerLabel="View basketball gear" icon="sports_basketball" iconClass="text-orange-500" />
          </SectionCard>
          <SectionCard title="Soccer" icon="sports_soccer" iconClass="text-green-600">
            <FeedPreview widgetId="sports-soccer" trackerHref="/dashboard" trackerLabel="View soccer gear" icon="sports_soccer" iconClass="text-green-600" />
          </SectionCard>
          <SectionCard title="Football" icon="sports_football" iconClass="text-slate-700">
            <FeedPreview widgetId="sports-football" trackerHref="/dashboard" trackerLabel="View football gear" icon="sports_football" iconClass="text-slate-700" />
          </SectionCard>
        </div>
      </main>
