      ...
      <header className="sticky top-14 z-50 bg-[#f5f7f8]/80 dark:bg-[#101922]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center px-4 py-3 gap-3 max-w-3xl mx-auto w-full">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-400">Paints, canvases, brushes & art supply deals</p>
          </div>
        </div>
      </header>
      <main className="pb-24 md:pb-6">
        <div className="max-w-3xl mx-auto w-full px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <SectionCard title="New Art Supplies" icon="palette" iconClass="text-purple-500">
            <FeedPreview widgetId="art-supplies-new" trackerHref="/dashboard" trackerLabel="View new art supplies" icon="palette" iconClass="text-purple-500" />
          </SectionCard>
          <SectionCard title="Art Supply Deals" icon="sell" iconClass="text-amber-500">
            <FeedPreview widgetId="art-supplies-deals" trackerHref="/active-deals" trackerLabel="View all art deals" icon="sell" iconClass="text-amber-500" />
          </SectionCard>
          <SectionCard title="Prints & Originals" icon="image" iconClass="text-rose-400">
            <FeedPreview widgetId="art-prints" trackerHref="/dashboard" trackerLabel="View prints & originals" icon="image" iconClass="text-rose-400" />
          </SectionCard>
        </div>
      </main>
